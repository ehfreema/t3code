...
+ (NSProgress*)signMachOPathArr:(NSArray<NSString*>*)machoPathArr bundleId:(NSString *)bundleId cert:(NSData *)key
    ...
    return [self signMachOPathArr:machoPathArr bundleId:bundleId cert:key pass:pass entitlements:nil completionHandler:completionHandler];
}

+ (NSProgress*)signMachOPathArr:(NSArray<NSString*>*)machoPathArr bundleId:(NSString *)bundleId cert:(NSData *)key
                           pass:(NSString *)pass entitlements:(NSString *)entitlements completionHandler:(void(^)(BOOL success, NSError *error))completionHandler {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        if (ret && entitlements) {
            pSignAsset->m_strEntitleData = string([entitlements UTF8String]);
        }
        if (!ret) {
            delete pSignAsset;
...
+ (NSProgress*)signWithAppPath:(NSString *)appPath bundleId:(NSString *)bundleId cert:(NSData *)key pass:(NSString *)pass
    ...
    return [self signWithAppPath:appPath bundleId:bundleId cert:key pass:pass entitlements:nil completionHandler:completionHandler];
}

+ (NSProgress*)signWithAppPath:(NSString *)appPath bundleId:(NSString *)bundleId cert:(NSData *)key pass:(NSString *)pass entitlements:(NSString *)entitlements completionHandler:(void (^)(BOOL success, NSError *error))completionHandler {
    ...
    return [ZSigner signMachOPathArr:filesToSign bundleId:bundleId cert:key pass:pass entitlements:entitlements completionHandler:completionHandler];
}
